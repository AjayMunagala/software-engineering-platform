...
This accepted Phase 3.5.3 package implements callable liveness and readiness without
creating an HTTP endpoint, listener, logger, metric exporter, database pool, or
SQL dependency.
