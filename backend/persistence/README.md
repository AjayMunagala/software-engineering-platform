...
The reusable adapter suite lives in `persistence/conformance`. The accepted
Phase 3.4.3 PostgreSQL adapter passes it. Phase 3.4.4 final validation and
engineering acceptance remain required before the port can be frozen at
`1.0.0`.
...
Stable API `1.0.0`. Phase 3.4.4 was accepted on 2026-07-26. Compatibility rules
are frozen in `docs/API/PERSISTENCE_PORT_V1.md`.
