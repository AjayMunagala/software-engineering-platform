...
Design and implementation engineering accepted; candidate 0.1.0. Phase 5.0.2 is accepted at
...
Implementation commit `a0a1a779734b23a0f6c2a8f711130063822a9761` is accepted,
and ADR 0021 is Accepted. Phase 5.0.4 algorithms, integration,
